...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define TARGET_PID                  0x0418           /* STM32F107 Product ID */
#define IMAGE_ADDRESS               0x08020000       /* Example address for application image */
#define TARGET_FLASH_START_ADDRESS  0x08000000       /* Start address of the Flash memory */
#define TARGET_FLASH_END_ADDRESS    0x0803FFFF       /* End address for 256KB of Flash memory */
#define TARGET_OPB_START_ADDRESS    0x1FFFF800       /* Option Bytes start address */
...
#define stm32_nrst_low()        HAL_GPIO_WritePin(Uart_Enable_GPIO_Port, Uart_Enable_Pin, GPIO_PIN_RESET);
#define stm32_nrst_high()       HAL_GPIO_WritePin(Uart_Enable_GPIO_Port, Uart_Enable_Pin, GPIO_PIN_SET);

#define stm32_boot_low()        HAL_GPIO_WritePin(Boot_Pin_Control_GPIO_Port, Boot_Pin_Control_Pin, GPIO_PIN_RESET);
//#define stm32_boot_high()       HAL_GPIO_WritePin(ACK_0_GPIO_Port, ACK_0_Pin, GPIO_PIN_SET);
